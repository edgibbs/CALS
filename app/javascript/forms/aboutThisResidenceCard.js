...
const blankAboutThisResidenceFields = {
...
export default class AboutThisResidenceCard extends React.Component {
  ...
  onChange (value, e) {
    let data = blankAboutThisResidenceFields.residenceFieldValues
  ...
  render () {
    const aboutResidence = blankAboutThisResidenceFields
    const hiddenBodyOfWater = blankAboutThisResidenceFields.residenceFieldValues.body_of_water_exist ? '' : 'hidden'
    const hiddenUseAsMailingAddress = blankAboutThisResidenceFields.residenceFieldValues.others_using_residence_as_mailing ? '' : 'hidden'
        ...
        <div className='row'>
          <form>
            <DropDownField id='residenceTypes' gridClassName='col-md-7'
              ...
              value={getDictionaryId(aboutResidence.residenceFieldValues.residence_ownership_type)}
            ...
            <DropDownField id='weapons' gridClassName='col-md-7'
              selectClassName={'reusable-select'}
              value={blankAboutThisResidenceFields.yesNo.value}
            ...
            <DropDownField id='body_of_water_exist' gridClassName='col-md-7'
              selectClassName={'reusable-select'}
              value={blankAboutThisResidenceFields.residenceFieldValues.body_of_water_exist.value}
              optionList={yesNo.items}
              label={'Body of Water?'}
            ...
            <div className={hiddenBodyOfWater}>
              <TextAreaComponent gridClassName='col-md-12' id='body_of_water_description'
                value={blankAboutThisResidenceFields.residenceFieldValues.body_of_water_description}
            ...
            <div className={hiddenUseAsMailingAddress} >
              <InputComponent gridClassName='col-md-4' id='firstName' value={blankAboutThisResidenceFields.residenceFieldValues.other_people_using_residence_as_mailing[0]['nameField']['first_name']}
                label='First Name' placeholder='Enter First Name'
                onChange={(event) => this.onChange(event.target.value, ('first_name'))} />
              <InputComponent gridClassName='col-md-4' id='middleName' value={blankAboutThisResidenceFields.residenceFieldValues.other_people_using_residence_as_mailing[0]['nameField']['middle_name']}
                label='Middle Name' placeholder='Enter Middle Name'
                onChange={(event) => this.onChange(event.target.value, ('middle_name'))} />
              <InputComponent gridClassName='col-md-4' id='lastName' value={blankAboutThisResidenceFields.residenceFieldValues.other_people_using_residence_as_mailing[0]['nameField']['last_name']}
                label='Last Name' placeholder='Enter Last Name'
                onChange={(event) => this.onChange(event.target.value, ('last_name'))} />
            </div>

            <TextAreaComponent gridClassName='col-md-12' id='directions'
              value={blankAboutThisResidenceFields.directions}
            ...
            <DropDownField id='languagesSpoken' gridClassName='col-md-12'
              selectClassName={'reusable-select'}
              value={blankAboutThisResidenceFields.residenceFieldValues.home_languages.id}
              optionList={this.props.languageTypes.items}
