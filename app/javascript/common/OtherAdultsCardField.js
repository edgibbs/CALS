      ...
      <div className='row list-item' >
        <div > <span onClick={() => this.clickClose(this.props.id)} className='pull-right glyphicon glyphicon-remove' />
          ...
          <DropDownField gridClassName='col-md-4' id='relationshipType' value={adult.relationshipType}
            ...
            label='Relationship Type' onChange={(event) => this.props.onFieldChange(this.props.value, event.target.value, 'relationshipType')} />
          <DropDownField gridClassName='col-md-4' id='availableApplicants'
            selectClassName='reusable-select'
            optionList={adult.availableApplicants.items}
            label='To Whom' onChange={(event) => this.props.onFieldChange(this.props.value, event.target.value, 'availableApplicant')} />
          <InputComponent gridClassName='col-md-4' id='dateOfBirth' value={adult.dateOfBirth}
            ...
            type='text' onChange={(event) => this.props.onFieldChange(this.props.value, event.target.value, 'dateOfBirth')} />
          <InputComponent gridClassName='col-md-4' id='firstName' value={adult.nameField.firstName}
            label='First Name' placeholder='Enter First Name'
            type='text' onChange={(event) => this.props.handleNameFieldInput(this.props.value, event.target.value, ('firstName'))} />
          <InputComponent gridClassName='col-md-4' id='middleName' value={adult.nameField.middleName}
            ...
            type='text' onChange={(event, id) => this.props.handleNameFieldInput(event.target.value, ('middleName'))} />
          <InputComponent gridClassName='col-md-4' id='lastName' value={adult.nameField.lastName}
            label='Last Name' placeholder='Enter Last Name'
            type='text' onChange={(event, id) => this.props.handleNameFieldInput(event.target.value, ('lastName'))} />
        </form>
      </div>
